  ...
  public void mainMenu() {
    ...
    while (loop) {
      ...
      switch (fullAnswer) {
        ...
        case ("go north") -> mazeWall(playerPosition.goNorth());
        case ("go south") -> mazeWall(playerPosition.goSouth());
        case ("go east") -> mazeWall(playerPosition.goEast());
        case ("go west") -> mazeWall(playerPosition.goWest());
